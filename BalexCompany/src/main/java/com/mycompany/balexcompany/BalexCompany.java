...
/**
 * This class represents a company called BalexCompany.
 * It has a method to calculate the total pay for an employee based on their base pay and hours worked.
 */
public class BalexCompany {
    /**
     * This method calculates the total pay for an employee.
     * It takes the base pay and hours worked as parameters and prints the total pay or an error message.
     * 
